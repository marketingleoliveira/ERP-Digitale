...
export const ALL_MENU_ITEMS: MenuItem[] = [
 ...
 { title: "MRP → Sugestão de OP", url: "/pcp/mrp-op", icon: Factory, group: "Produção (PCP)" },
  { title: "Vínculos Produto → Artigo", url: "/pcp/vinculos-artigo", icon: Package, group: "Produção (PCP)" },
  { title: "Reservas de Material", url: "/pcp/reservas", icon: Package, group: "Produção (PCP)" },
  { title: "MPS — Plano Mestre", url: "/pcp/mps", icon: LayoutDashboard, group: "Produção (PCP)" },
  { title: "Programação (Gantt)", url: "/pcp/programacao", icon: Clock, group: "Produção (PCP)" },
  { title: "Motivos de Parada", url: "/pcp/motivos-parada", icon: Wrench, group: "Produção (PCP)" },
  { title: "Kanban de OPs", url: "/producao/kanban", icon: Scissors, group: "Produção (PCP)" },
  { title: "Chão de Fábrica", url: "/producao/chao-fabrica", icon: Factory, group: "Produção (PCP)" },
