...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sistema ERP Digitale Têxtil" },
      { name: "description", content: "Sistema ERP Desevolvido exclusivamente por Digitale Têxtil" },
      { name: "author", content: "Digitale Têxtil" },
      { property: "og:title", content: "Sistema ERP Digitale Têxtil" },
      { property: "og:description", content: "Sistema ERP Desevolvido exclusivamente por Digitale Têxtil" },
